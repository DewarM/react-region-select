	...
	render() {
		return (
			<div style={{textAlign: 'center'}}>
				<RegionSelect regionStyle={{backgroundColor: 'rgba(0,0,0,0.5)'}} constraint={true} maxRegions={1} regions={this.state.regions} onChange={this.onChange} regionRenderer={this.regionRenderer}>
